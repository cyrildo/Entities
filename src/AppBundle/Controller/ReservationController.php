...
class ReservationController extends Controller
{
    ...
    public function newAction(Request $request, Mailer $mailer)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $mailer->sendMail($reservation->getFlight()->getPilot()->getEmail(),'Info', 'you have a new reservation');
            $mailer->sendMail($this->getUser()->getEmail(), 'confirmation', 'your reservation is vaidated');
            // Pilot mail
